...
<body>
	...
	<button onclick ="location.href ='regForm.jsp';">부서 등록 하기</button>
...
<%
		...
		<tr>
			...
			<td><a href="editForm.jsp?deptno=<%= list.get(i).getDeptno() %>">수정</a> 
	...
	<Script>
		function delDept(deptno){
			if(confirm('정말 삭제하시겠습니까?')){
				location.href='deleteDept.jsp?deptno='+deptno;
			}
		}
