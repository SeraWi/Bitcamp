...
//	① 아래의 데이터를 저장 이름, 전화번호, 전공, 학년, email, 생일, 주소
	...
	private String birthday; // 2020-10-10 -> String으로 
	private String address;
	
	// 접근제어 지시자 Private을 쓰는 이유
	// 클래스 내부의 멤버들만 참조가 가능: 정보 은닉, 변수의 데이터를 보호하기 위해,
...
//	② 위에서 정의한 정보를 출력하는 메소드 정의
	...
	public void setName(String name) { //private 접근하기위해
		this.name = name;
	}
...
//	④ main() 메소드에서 두 가지 생성자를 이용해서 인스턴스 생성하고 출력 메소드를 통해 저장된 데이터 출력
	public static void main(String[] args) {
		...
		Member2 member2 = new Member2("손흥민","010-999-9999","축구",1,"son@gmail.com");
		member2.showInfo();
	}
}
