...
public class DeptManager {
	...
	private DeptDao dao; //외부에서 바꾸지 못하도록 private
	private Scanner sc;
	...
	// 데이터 입력
	//사용자에게 Scanner 클래스로 입력받아 저장 ->dao insertDept()메소드로 저장
	void inputData() {
		//connection객체 생성
		Connection conn = null;
	...
	// 데이터 수정
	//사용자에게 Scanner 클래스로 입력받아 수정->dao editDept() 메소드 이용
	void editData() {
		//connection객체 생성
		Connection conn = null;
		...
		try {
			...
			System.out.println("부서번호 부서이름 부서 위치 형식으로 입력해주세요.");
