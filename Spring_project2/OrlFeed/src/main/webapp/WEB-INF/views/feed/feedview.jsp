...
<body>
		...
		<section class="container_view">
			...
			<section class="v_rightbox">
				...
				<div class="v_profile">
					...
					<!-- 피드 수정/삭제 버튼 (내 피드일때만) -->
					<c:if
						test="${sessionScope.memberVo.memberIdx eq selectFeedView.memberIdx}">
						<!-- 수정 버튼 -->
						<div class="edit_div">
					...
					<div class="v_photo">
						<button
							...
							<img src="<c:url value="/images/feed/feedw/defaultPhoto.jpg"/>"
								alt="profile-img">
						</button>
					</div>
    ...
    $(document).ready(function(){
        ...
        $('#pageBack').click(function(){
        	location.href = '<c:url value="/feed/feedmain"/>'; /****************** 수정 ***********************/
        });
